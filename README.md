...
- Rust GUI MVP на `egui/eframe`, включая восстановленную центральную доску, левую панель управления, верхнее меню, drag-and-drop, undo/redo, прокрутку партии стрелками, SAN-историю, legal moves panel, визуальную шкалу оценки, кастомизируемые цвета/фигуры и вывод UCI `info`.
